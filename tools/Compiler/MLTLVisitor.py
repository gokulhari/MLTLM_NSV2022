...
class MLTLVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MLTLParser#UnaryTimescaleExpr.
    def visitUnaryTimescaleExpr(self, ctx:MLTLParser.UnaryTimescaleExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MLTLParser#BinaryTimescaleExpr.
    def visitBinaryTimescaleExpr(self, ctx:MLTLParser.BinaryTimescaleExprContext):
        return self.visitChildren(ctx)
