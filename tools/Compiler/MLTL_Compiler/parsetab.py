...
_lr_productions = [
  ...
  ('program -> program statement','program',2,'p_program','MLTLparse.py',23),
  ('program -> statement','program',1,'p_program','MLTLparse.py',24),
  ('statement -> expression SEMI','statement',2,'p_statement','MLTLparse.py',35),
  ('expression -> expression AND expression','expression',3,'p_prop_operators','MLTLparse.py',41),
  ('expression -> NEG expression','expression',2,'p_prop_operators','MLTLparse.py',42),
  ('expression -> expression OR expression','expression',3,'p_prop_operators','MLTLparse.py',43),
  ('expression -> expression EQ expression','expression',3,'p_prop_operators','MLTLparse.py',44),
  ('expression -> expression IMPLY expression','expression',3,'p_prop_operators','MLTLparse.py',45),
  ('expression -> GLOBAL LBRACK NUMBER RBRACK expression','expression',5,'p_ftMLTL_operators','MLTLparse.py',75),
  ('expression -> GLOBAL LBRACK NUMBER COMMA NUMBER RBRACK expression','expression',7,'p_ftMLTL_operators','MLTLparse.py',76),
  ('expression -> FUTURE LBRACK NUMBER RBRACK expression','expression',5,'p_ftMLTL_operators','MLTLparse.py',77),
  ('expression -> FUTURE LBRACK NUMBER COMMA NUMBER RBRACK expression','expression',7,'p_ftMLTL_operators','MLTLparse.py',78),
  ('expression -> expression UNTIL LBRACK NUMBER RBRACK expression','expression',6,'p_ftMLTL_operators','MLTLparse.py',79),
  ('expression -> expression UNTIL LBRACK NUMBER COMMA NUMBER RBRACK expression','expression',8,'p_ftMLTL_operators','MLTLparse.py',80),
  ('expression -> expression RELEASE LBRACK NUMBER RBRACK expression','expression',6,'p_ftMLTL_operators','MLTLparse.py',81),
  ('expression -> expression RELEASE LBRACK NUMBER COMMA NUMBER RBRACK expression','expression',8,'p_ftMLTL_operators','MLTLparse.py',82),
  ('expression -> YESTERDAY expression','expression',2,'p_ptMLTL_operators','MLTLparse.py',111),
  ('expression -> expression SINCE expression','expression',3,'p_ptMLTL_operators','MLTLparse.py',112),
  ('expression -> expression SINCE LBRACK NUMBER COMMA NUMBER RBRACK expression','expression',8,'p_ptMLTL_operators','MLTLparse.py',113),
  ('expression -> ONCE expression','expression',2,'p_ptMLTL_operators','MLTLparse.py',114),
  ('expression -> ONCE LBRACK NUMBER RBRACK expression','expression',5,'p_ptMLTL_operators','MLTLparse.py',115),
  ('expression -> ONCE LBRACK NUMBER COMMA NUMBER RBRACK expression','expression',7,'p_ptMLTL_operators','MLTLparse.py',116),
  ('expression -> HISTORICALLY expression','expression',2,'p_ptMLTL_operators','MLTLparse.py',117),
  ('expression -> HISTORICALLY LBRACK NUMBER RBRACK expression','expression',5,'p_ptMLTL_operators','MLTLparse.py',118),
  ('expression -> HISTORICALLY LBRACK NUMBER COMMA NUMBER RBRACK expression','expression',7,'p_ptMLTL_operators','MLTLparse.py',119),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_paren_token','MLTLparse.py',162),
  ('expression -> ATOMIC','expression',1,'p_atomic_token','MLTLparse.py',166),
  ('expression -> TRUE','expression',1,'p_bool_token','MLTLparse.py',174),
  ('expression -> FALSE','expression',1,'p_bool_token','MLTLparse.py',175),
]
