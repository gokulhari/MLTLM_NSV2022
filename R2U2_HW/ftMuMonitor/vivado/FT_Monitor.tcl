...
#
# mu_monitor.tcl: Tcl script for re-creating project 'FT_Monitor'
#
# Generated by Vivado on Tue Jun 06 16:22:13 -0500 2017
...
#
# 1. This project restoration tcl script (mu_monitor.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "hdl/ftMuMonitor/sim/testbench/tb_behav.wcfg"
#    "hdl/ftMuMonitor/sim/testbench/atomic.trc"
#
# 3. The following remote source files that were added to the original project:-
#
#    "hdl/util/cevLib_unsigned_pkg.vhd"
#    "hdl/util/math_pkg.vhd"
#    "hdl/ftMuMonitor/sim/testbench/log_input_pkg.vhd"
#    "hdl/muMonitorV2/mu_monitor_pkg.vhd"
#    "hdl/buildingBlocks/ram/sp_ram_wt.vhd"
#    "hdl/ftMuMonitor/ft_mu_monitor_pkg.vhd"
#    "hdl/buildingBlocks/ram/ram_pkg.vhd"
#    "hdl/buildingBlocks/ram/sp_ram.vhd"
#    "hdl/ftMuMonitor/ft_queue.vhd"
#    "hdl/ftMuMonitor/ft_mu_monitor_fsm.vhd"
#    "hdl/ftMuMonitor/ft_mu_monitor.vhd"
#    "hdl/util/testbench_util_pkg.vhd"
#    "hdl/ftMuMonitor/sim/testbench/tb.vhd"
#    "hdl/ftMuMonitor/sim/testbench/imem.imem.int"
#    "hdl/ftMuMonitor/sim/testbench/imem.imem"
#
#*****************************************************************************************
...
set script_file "FT_Monitor.tcl"
...
# Create project
create_project -f FT_Monitor ./FT_Monitor

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects FT_Monitor]
set_property "board_part" "" $obj
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/FT_Monitor.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/FT_Monitor.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/FT_Monitor.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/FT_Monitor.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/FT_Monitor.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/FT_Monitor.cache/compile_simlib/vcs" $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/ftMuMonitor/sim/testbench/log_input_pkg.vhd"]"\
 "[file normalize "$origin_dir/muMonitorV2/mu_monitor_pkg.vhd"]"\
 "[file normalize "$origin_dir/buildingBlocks/ram/sp_ram_wt.vhd"]"\
 "[file normalize "$origin_dir/ftMuMonitor/ft_mu_monitor_pkg.vhd"]"\
 ...
 "[file normalize "$origin_dir/ftMuMonitor/ft_queue.vhd"]"\
 "[file normalize "$origin_dir/ftMuMonitor/ft_mu_monitor_fsm.vhd"]"\
 "[file normalize "$origin_dir/ftMuMonitor/ft_mu_monitor.vhd"]"\
...
set file "$origin_dir/ftMuMonitor/sim/testbench/log_input_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/muMonitorV2/mu_monitor_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/ftMuMonitor/ft_mu_monitor_pkg.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/ftMuMonitor/ft_queue.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/ftMuMonitor/ft_mu_monitor_fsm.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/ftMuMonitor/ft_mu_monitor.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
...
set_property "top" "ft_mu_monitor" $obj
...
set files [list \
 "[file normalize "$origin_dir/ftMuMonitor/sim/testbench/tb.vhd"]"\
 "[file normalize "$origin_dir/ftMuMonitor/vivado/tb_behav.wcfg"]"\
 "[file normalize "$origin_dir/ftMuMonitor/sim/testbench/imem.imem.int"]"\
 "[file normalize "$origin_dir/ftMuMonitor/sim/testbench/atomic.trc"]"\
 "[file normalize "$origin_dir/ftMuMonitor/sim/testbench/imem.imem"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/ftMuMonitor/sim/testbench/tb.vhd"
set file [file normalize $file]
...
set file "$origin_dir/ftMuMonitor/sim/testbench/imem.imem.int"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
...
set file "$origin_dir/ftMuMonitor/sim/testbench/imem.imem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property "file_type" "Data Files" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "$origin_dir/ftMuMonitor/sim/testbench/atomic.trc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property "file_type" "Data Files" $file_obj
set_property "is_enabled" "1" $file_obj
...
set file "ftMuMonitor/vivado/tb_behav.wcfg"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
set_property "library" "xil_defaultlib" $file_obj
...
set_property "xsim.view" "FT_Monitor/tb_behav.wcfg /FT_Monitor/tb_behav.wcfg /FT_Monitor/tb_behav.wcfg" $obj
...
puts "INFO: Project created:FT_Monitor"
