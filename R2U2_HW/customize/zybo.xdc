...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets RESET_low_IBUF]
...
##Buttons
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { RESET_low }]; #IO_L20N_T3_34 Sch=BTN0
...
##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { LD0 }]; #IO_L23P_T3_35 Sch=LED0
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { LD1 }]; #IO_L23N_T3_35 Sch=LED1
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { LD2 }]; #IO_0_35=Sch=LED2
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { FPGA_SERIAL1_TX }]; #IO_L15P_T2_DQS_34 Sch=JB1_p
...
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { FPGA_SERIAL1_RX }]; #IO_L17P_T2_34 Sch=JB3_P
